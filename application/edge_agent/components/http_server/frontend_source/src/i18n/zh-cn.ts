...
export const zhCn: Dict = {
  ...
  systemSubtitle: 'FreeRTOS 任务、堆和正常运行时间的实时快照。比 top 更轻量——刷新频率可调。',
  systemRefreshLabel: '刷新',
  systemSectionOverview: '概览',
  systemSectionMemory: '内存',
  systemSectionTasks: '任务',
  systemUptime: '正常运行',
  systemTaskCount: '任务数',
  systemResetReason: '上次重启',
  systemCpu: 'CPU',
  systemHeapInternal: '内部堆',
  systemHeapPsram: 'PSRAM',
  systemHeapFree: '空闲',
  systemPsramNone: '无 PSRAM',
  systemMinHeap: '历史最低堆',
  systemMinHeapSub: '自启动以来',
  systemRuntimeOn: '运行时统计已开启',
  systemRuntimeOff: '运行时统计未开启',
  systemRuntimeStatsMissing: '当前固件未启用 FreeRTOS 运行时统计，CPU% 不可用。',
  systemColName: '名称',
  systemColState: '状态',
  systemColPriority: '优先级',
  systemColCpu: 'CPU%',
  systemColStack: '剩余栈',
  systemColCore: '核心',
