export const en = {
  ...
  systemSubtitle: 'Live snapshot of FreeRTOS tasks, heap usage and uptime. Lighter than top — refresh rate is configurable.',
  systemRefreshLabel: 'Refresh',
  systemSectionOverview: 'Overview',
  systemSectionMemory: 'Memory',
  systemSectionTasks: 'Tasks',
  systemUptime: 'Uptime',
  systemTaskCount: 'Tasks',
  systemResetReason: 'Last reset',
  systemCpu: 'CPU',
  systemHeapInternal: 'Internal heap',
  systemHeapPsram: 'PSRAM',
  systemHeapFree: 'free',
  systemPsramNone: 'no PSRAM',
  systemMinHeap: 'Min free heap',
  systemMinHeapSub: 'lowest ever since boot',
  systemRuntimeOn: 'runtime stats on',
  systemRuntimeOff: 'runtime stats off',
  systemRuntimeStatsMissing:
    'CPU% column unavailable: this firmware was built without FreeRTOS run-time stats. Tasks are still listed.',
  systemColName: 'Name',
  systemColState: 'State',
  systemColPriority: 'Prio',
  systemColCpu: 'CPU%',
  systemColStack: 'Stack free',
  systemColCore: 'Core',
